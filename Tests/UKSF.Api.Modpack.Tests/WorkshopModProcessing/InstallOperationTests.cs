...
public class InstallOperationTests
{
    ...
    [Fact]
    public async Task ExecuteAsync_WithSelectedExtensions_ShouldCopyAndTrackThem()
    {
        var workshopMod = SetupWorkshopMod();
        var selectedExtensions = new List<string> { "ctab_connect.dll", "userconfig/ctab/settings.hpp" };
