...
namespace UKSF.Tests.Unit.Signalr {
    public class CommentThreadHubTests {
        public CommentThreadHubTests() {
            id = ObjectId.GenerateNewId().ToString();
            IQueryCollection queryCollection = new QueryCollection(new Dictionary<string, StringValues> {{"threadId", id}});
        ...
        public async Task ShouldAddToGroup() {
            ...
            await commentThreadHub.OnConnectedAsync();
