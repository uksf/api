...
namespace UKSF.Tests.Unit.Signalr {
    public class AccountHubTests {
        ...
        public async Task ShouldAddToGroup() {
            ...
            AccountHub accountHub = new AccountHub {Context = mockHubCallerContext.Object, Groups = mockGroupManager.Object};
            await accountHub.OnConnectedAsync();
        ...
        public async Task ShouldRemoveFromGroup() {
            ...
            AccountHub accountHub = new AccountHub {Context = mockHubCallerContext.Object, Groups = mockGroupManager.Object};
            await accountHub.OnDisconnectedAsync(null);
