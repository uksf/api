...
public class DiscordService : IDiscordService, IDisposable
{
    ...
    {
        return message != null &&
               message.Content.Contains(_variablesService.GetVariable("DISCORD_FILTER_WEEKLY_EVENTS").AsString(), StringComparison.InvariantCultureIgnoreCase);
    }
    ...
    {
        var auditLogsEnumerator = _guild.GetAuditLogsAsync(10, RequestOptions.Default, null, null, ActionType.MessageDeleted).GetAsyncEnumerator();
        try
        {
    ...
    {
        var auditLogsEnumerator = _guild.GetAuditLogsAsync(10, RequestOptions.Default, null, null, ActionType.Ban).GetAsyncEnumerator();
        try
        {
            while (await auditLogsEnumerator.MoveNextAsync())
            {
    ...
    {
        var auditLogsEnumerator = _guild.GetAuditLogsAsync(10, RequestOptions.Default, null, null, ActionType.Unban).GetAsyncEnumerator();
        try
        {
            while (await auditLogsEnumerator.MoveNextAsync())
            {
