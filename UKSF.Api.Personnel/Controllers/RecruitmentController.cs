...
namespace UKSF.Api.Personnel.Controllers
{
    ...
    public class RecruitmentController : Controller
    {
        ...
        {
            return Ok(_recruitmentService.GetAllApplications());
        }
        ...
        public IActionResult GetIsRecruiter()
        {
            return Ok(new { recruiter = _recruitmentService.IsRecruiter(_accountService.GetUserAccount()) });
        }
