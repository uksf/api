...
namespace UKSF.Api.Integrations.Instagram.ScheduledActions {
    ...
    public class ActionInstagramToken : IActionInstagramToken {
        ...
        public ActionInstagramToken(ISchedulerContext schedulerContext, IInstagramService instagramService, ISchedulerService schedulerService, IHostEnvironment currentEnvironment, IClock clock) {
