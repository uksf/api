...
namespace UKSF.Tests.Unit.Data.Personnel
{
    public class DischargeDataServiceTests
    {
        ...
        public void Should_get_collection_in_order()
        {
            ...
            DischargeCollection item1 = new() { Discharges = new() { new() { Timestamp = DateTime.Now.AddDays(-3) } } };
            DischargeCollection item2 = new() { Discharges = new() { new() { Timestamp = DateTime.Now.AddDays(-10) }, new() { Timestamp = DateTime.Now.AddDays(-1) } } };
            DischargeCollection item3 = new() { Discharges = new() { new() { Timestamp = DateTime.Now.AddDays(-5) }, new() { Timestamp = DateTime.Now.AddDays(-2) } } };
