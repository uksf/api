...
namespace UKSF.Tests.Unit.Data.Personnel
{
    public class DischargeDataServiceTests
    {
        ...
        public void Should_get_collection_in_order()
        {
            ...
            DischargeCollection item2 = new() { Discharges = new() { new() { Timestamp = DateTime.UtcNow.AddDays(-10) }, new() { Timestamp = DateTime.UtcNow.AddDays(-1) } } };
            DischargeCollection item3 = new() { Discharges = new() { new() { Timestamp = DateTime.UtcNow.AddDays(-5) }, new() { Timestamp = DateTime.UtcNow.AddDays(-2) } } };
