...
namespace UKSF.Tests.Unit.Services.Personnel {
    public class RanksServiceTests {
        ...
        public void ShouldSortCollection() {
            Account account1 = new() { Rank = "Private" };
            Account account2 = new() { Rank = "Candidate" };
            Account account3 = new() { Rank = "Recruit" };
            Account account4 = new() { Rank = "Private" };
            List<Account> subject = new() { account1, account2, account3, account4 };
